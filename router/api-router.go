...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		allergyAdminRoute.Use(middleware.AdminAuth())
		{
			...
			allergyAdminRoute.POST("/orders/:id/sample-sent-back", controller.MarkAdminAllergySampleSentBack)
			allergyAdminRoute.POST("/orders/:id/sample-received", controller.MarkAdminAllergySampleReceived)
			allergyAdminRoute.POST("/orders/:id/testing-started", controller.StartAdminAllergyTesting)
			allergyAdminRoute.POST("/orders/:id/report", controller.UploadAdminAllergyOrderReport)
			allergyAdminRoute.POST("/orders/:id/complete", controller.CompleteAdminAllergyOrder)
			allergyAdminRoute.GET("/reports/:id/preview", controller.PreviewAdminAllergyReport)
			allergyAdminRoute.GET("/reports/:id/download", controller.DownloadAdminAllergyReport)
